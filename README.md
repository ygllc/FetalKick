...
2. **Tap "New Session"** — The app enters setup mode with meal and date selection enabled
3. **Choose your meal** — Select Breakfast, Lunch, Snacks, or Dinner
4. **Pick a date** — Use the date picker, then confirm with "OK"
5. **Start counting** — The app enters counting mode with your selected meal and date shown. You
   can:
...
Monitoring fetal movements is a simple way to stay aware of your baby's activity patterns. Most
healthcare providers recommend tracking kicks starting around week 28 of pregnancy. FetalKick makes
it easy to notice patterns and share data with your care team.
...
2. Open FetalKick and tap "New Session"
